...
function Inventory({ onNewDataAdded }: InventoryProps) {
          ...
          const response = await fetch('/api/inventory/create', {
            ...
            .then(data => {
              if (data.success === false) {
                ...
                setIsLoading(false);
                onNewDataAdded(); // Call the callback function to fetch new data
              }
            });
        }
        action.resetForm();
  ...
  return (
    <div className="">
      <button onClick={openModal} className="btn bg-red-400 btn-sm">
        Add Inventory
      </button>
                ...
                <div className="flex text-[12px]">
                  <div className="w-96">
                    ...
                    <p className="text-red-500 text-xs mt-1 ml-1">
                      {touched.inventoryType && errors.inventoryType ? <div>{errors.inventoryType}</div> : null}
                    </p>
                    {values.inventoryType == "in" ? (
                      <>
                        <div className="mb-3">
                          <InputType labelTxt='Donor Email' inputType='text' id='email' name='email' value={values.email} onChange={handleChange} />
                          <p className="text-red-500 text-xs mt-1 ml-1">
                    ...
                    <div className="mb-3">
                      ...
                      >
                        <option defaultValue={"Open this select menu"}>Select a blood group</option>
